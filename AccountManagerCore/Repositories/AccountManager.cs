...
namespace AccountCore.Repositories
{
    ...
    public class AccountManager : IAccountManager
    {
        ...
        public async Task<Tuple<bool, string[]>> CreateUserAsync(ApplicationUsers user, IEnumerable<string> roles, string password)
        {
        ...
        public async Task<Tuple<bool, string[]>> DeleteUserAsync(ApplicationUsers user)
        {
        ...
        public async Task<Tuple<ApplicationUsers, string[]>> GetUserAndRolesAsync(string userId)
        {
        ...
        public async Task<List<Tuple<ApplicationUsers, string[]>>> GetUsersAndRolesAsync(int page, int pageSize)
        {
            throw new NotSupportedException();
        ...
        public async Task<Tuple<bool, string[]>> UpdateUserAsync(ApplicationUsers user)
        {
            return await UpdateUserAsync(user, null);
        }


        public async Task<Tuple<bool, string[]>> UpdateUserAsync(ApplicationUsers user, IEnumerable<string> roles)
        {
        ...
        public async Task<Tuple<bool, string[]>> ResetPasswordAsync(ApplicationUsers user, string newPassword)
        {
        ...
        public async Task<Tuple<bool, string[]>> UpdatePasswordAsync(ApplicationUsers user, string currentPassword, string newPassword)
        {
        ...
        public async Task<Tuple<bool, string[]>> CreateRoleAsync(ApplicationRoles role, IEnumerable<string> claims)
        {
            if (claims == null)
                claims = new string[] { };
